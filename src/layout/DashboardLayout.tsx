...
export default function DashboardLayout() {
    ...
    return (
        <div className="flex min-h-screen w-full">
            {/* kiri */}
            <div className="w-64 bg-red-800 h-screen p-4 flex flex-col justify-between">
                {/* nama aplikasi */}
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <Link to="/dashboard/category" className="text-white p-4 hover:bg-black">
                        Category
                    </Link>
                ...
                <div>
                    <button 
                        ...
                        className="bg-red-200 p-2 text-red-600 w-full hover:bg-gray-100 hover:text-black" type="button">
                        Logout
                    </button>
                </div>
            </div>
